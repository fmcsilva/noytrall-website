            ...
            <div className="uk-margin-medium">
              ...
              <div className="uk-margin">
                ...
                <div className="uk-form-controls uk-inline">
                  ...
                  >
                    <option disabled>Select an option</option>
                    <option>Accomodation Business</option>
                    <option>Consulting Company</option>
                    <option>Architecture Office</option>
              ...
              <div className="uk-margin">
                ...
                <div className="uk-form-controls uk-inline">
                  ...
                  >
                    <option disabled>Select an option</option>
                    <option>Hotel</option>
                    <option>Conference Hotel</option>
                    ...
                    <option>B&B</option>
                    <option>Inn or Motel</option>
                    <option>Ecotourism Lodge</option>
                    <option>Country Retreat</option>
                    <option>Other</option>
                  </select>
                </div>
              </div>
              ...
              <div className="uk-margin">
                ...
                <div className="uk-form-controls uk-inline">
                  ...
                  >
                    ...
                    <option>Hotel Network</option>
                    <option>Hospitality Management Company</option>
