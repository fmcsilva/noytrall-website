            ...
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                <div className="uk-text-left">
                  <h3 className="uk-text-top uk-margin-remove">
                    Miguel Clemente
                  </h3>
                ...
                <div>
                  <a
                    href="https://www.linkedin.com/in/miguelrolinhoclemente/"
                    target="_blank"
                  >
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div>
                  <a
                    href="https://www.linkedin.com/in/miguel-onofre/"
                    target="_blank"
                  >
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div>
                  <a
                    href="https://www.linkedin.com/in/ferreira-diana/"
                    target="_blank"
                  >
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div>
                  <a
                    href="https://www.linkedin.com/in/davidrolinhoclemente/"
                    target="_blank"
                  >
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div className="">
                  <a
                    href="https://www.linkedin.com/in/francisco-silva-a74634184/"
                    target="_blank"
                  >
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div>
                  <a href="https://www.linkedin.com/in/pcout" target="_blank">
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
                </div>
              </div>
          ...
          <div>
            <div data-uk-grid>
              ...
              <div className="uk-width-expand@s">
                ...
                <div className="">
                  <a
                    href="https://www.linkedin.com/in/marcoalves1/"
                    target="_blank"
                  >
                    <i className="lab la-lg la-linkedin-in"></i>
                  </a>
